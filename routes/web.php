...
Route::get('/flights-home1', [FlightSearchController::class, 'home1']);
...
// The existing API and POST processing routes
    Route::get('/api/airports', [FlightSearchController::class, 'searchAirports'])->name('api.airports');
    Route::post('/flights/search', [FlightSearchController::class, 'processSearch'])->name('flights.process');
});
/*
|--------------------------------------------------------------------------
| Dashboards
